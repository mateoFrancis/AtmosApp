...
function test_marker(){
    makeMarker(34.0522, -118.2437, 0, 72.5, 80.5, 15.2, 295.7, 10, "2025-04-26 01:42 PM PDT", 90001, 'sunny', 75, 63, 0.5, 'clear');
    makeMarker(33.8696, -118.2200, 1, 85.1, 91.2, 5.7, 297.4, 12, "2025-04-27 02:05 AM PDT", 90045, 'cloudy', 80, 68, 1.2, 'partly cloudy');
    makeMarker(33.7925, -118.2250, 2, 66.3, 82, 8, 301.4, 27, "2025-04-27 02:05 AM PDT", 90066, 'rainy', 70, 58, 4.3, 'rain showers');
};
...
`;
  ...
  [hdr1, data1, hdr2, data2, hdr3, data3, spacer].forEach(row => {
    ...
    let tablebody = document.querySelector('.myOtherTable');
    tablebody.appendChild(newrow);
*/
    
    //Sets severiy for the index
    //Completly arbitrary, change when pins are added probably
    let iconURL = '';
